...
const DashboardWrapper: FC = () => {
  ...
  const [activeView, setActiveView] = useState<'links' | 'personas' | 'analytics' | 'appearance' | 'notifications' | 'settings'>('links');
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'personas':
        return <PersonaList personas={personas} onDelete={handleDeletePersona} />;
      case 'analytics':
        return (
      ...
      case 'notifications':
        return (
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg">
            ...
            <p className="text-gray-600 dark:text-gray-300">Manage your notifications...</p>
          </div>
        );
      case 'settings':
        return <Settings />;
