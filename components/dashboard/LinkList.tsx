...
import { GripVertical, Trash2, Globe, Twitter, Github, Instagram, Linkedin } from 'lucide-react';
...
const SortableLink: React.FC<LinkItemProps> = ({ link, onDelete }) => {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-2"
    >
...
export const LinkList: React.FC<LinkListProps> = ({ links, onDelete }) => {
  return (
    <div>
      <h2 className="text-2xl font-bold mb-6 dark:text-white">Your Links</h2>
