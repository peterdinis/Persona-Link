...
export namespace Prisma {
  ...
  */
    ...
    > = {
        [P in keyof T & keyof AggregateVerification]: P extends
            | '_count'
            | 'count'
            ? T[P] extends true
                ? number
                ...
                PickEnumerable<VerificationGroupByOutputType, T['by']> & {
                    [P in keyof T &
                        ...
                        ? T[P] extends boolean
                            ...
                            : GetScalarType<
                                  T[P],
                                  VerificationGroupByOutputType[P]
                              >
    ...
    > {
        ...
        createManyAndReturn<T extends VerificationCreateManyAndReturnArgs>(
            args?: SelectSubset<
                T,
                VerificationCreateManyAndReturnArgs<ExtArgs>
            >,
        ): Prisma.PrismaPromise<
            $Result.GetResult<
                Prisma.$VerificationPayload<ExtArgs>,
    ...
    export type VerificationWhereInput = {
        ...
        createdAt?:
            | DateTimeNullableFilter<'Verification'>
            | Date
            | string
            | null;
        updatedAt?:
    ...
    export type VerificationScalarWhereWithAggregatesInput = {
        ...
        expiresAt?:
            | DateTimeWithAggregatesFilter<'Verification'>
            | Date
            | string;
        createdAt?:
